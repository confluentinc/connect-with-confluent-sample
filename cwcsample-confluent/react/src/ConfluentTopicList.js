        ...
        return <tr key={topic.topic_name} className="align-middle">
            ...
            <td>
                <Button outline className="topic-button"
                    tag={Link}
                    to={"/connections/confluent/" + connectionName + "/" + clusterId + "/topic/" + topic.topic_name + "/produce"}
                >Produce</Button>
                <Button outline className="topic-button"
                        tag={Link}
                        to={"/connections/confluent/" + connectionName + "/" + clusterId + "/topic/" + topic.topic_name + "/consume"}
                >Consume</Button>
            </td>
        </tr>
    });
